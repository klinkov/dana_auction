...
$email = $_POST['mail']; // Принимаем данные
...
//   CURLOPT_POSTFIELDS => "entry.175484913=" + trim($_POST["mail"]) + "&entry.150908741=" + $_SERVER['SERVER_NAME'] + "&fbzx=4985693244102912634&partialResponse=%5Bnull%2Cnull%2C%224985693244102912634%22%5D",
...
curl_setopt_array($curl, [
  ...
  CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
  CURLOPT_CUSTOMREQUEST => "POST",
  CURLOPT_POSTFIELDS => "entry.175484913=qqqq%40gmail.com&entry.150908741=567&fbzx=4985693244102912634&partialResponse=%5Bnull%2Cnull%2C%224985693244102912634%22%5D",
  CURLOPT_COOKIE => "S=spreadsheet_forms%3DTPOgEOT7-kz5vysns939L7GbH2tyiYwskAF24zM2hpo; COMPASS=spreadsheet_forms%3DCjIACWuJVzailvltnDewjNjsoVIZb7xceiCmiCMf-b6hcn30OHqnlfrsyNJVUnvFNrEsDhCUtpWhBho0AAlriVdkhpdoaR9KpQ7Eag2VQAKWjb8_dWpFhslYXyPc_BdPNveY0wnescN1h0lY4bPWYA%3D%3D; NID=511%3DvD5dC6ceGIQvhNnUBpyhNJfl8GFupoWLTP6SDNovupZr2RrTo-rENaob1MLdam3vEOjHwev4fYroZzn9PO0RKWeCSJr7bVRxPK5O73-uZgTAO_ODiU05cAjMw2_PxCyj8TUXjOiUGOqzd4YxVYYvvM50dcA38RGHZ8MY-0CC-1A",
  CURLOPT_HTTPHEADER => [
    "Content-Type: application/x-www-form-urlencoded"
  ],
...
echo "entry.175484913=" + trim($_POST["mail"]) + "&entry.150908741=" + $_SERVER['SERVER_NAME'] + "&fbzx=4985693244102912634&partialResponse=%5Bnull%2Cnull%2C%224985693244102912634%22%5D";
